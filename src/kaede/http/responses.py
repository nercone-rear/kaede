...
class FileResponse(HTTPResponse):
    def __init__(self, path: Union[os.PathLike, Path], *, status_code: int = 200, headers: Optional[HTTPHeaders] = None, content_type: Optional[str] = None, compression: bool = True, range: Optional[Tuple[int, int]] = None):
